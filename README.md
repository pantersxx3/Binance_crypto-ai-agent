...
## ¡õ Advertencias de Riesgo

> **IMPORTANTE**: Este software es solo para fines educativos.

- ? El trading de criptomonedas conlleva **alto riesgo**
- ¡õ Nunca inviertas m¨¢s de lo que puedas perder
- ¡ö El rendimiento pasado **no garantiza** resultados futuros
- ? prueba en **Testnet/Dry Run** antes de Mainnet
- ¡ö El autor **no se responsabiliza** por p¨¦rdidas
